...
if __name__ == '__main__':
    ...
    players = ["xiaohong", "xiaolan", "xiaoming", "xiaohua","huhuaizhi",'liuhao']
    team_red = []
    team_blue = []
    team_green = []
    ...
    for p in copy_players:
        if p in team_red:
            show_red()
            print("player", p, "in team red")
        elif p in team_blue:
            show_blue()
            print("player", p, "in team blue")
        else:
            show_green()
            print("player", p, "in team green")
